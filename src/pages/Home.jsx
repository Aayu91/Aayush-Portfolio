...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/Aayu91' },
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/aayush-chauhan91/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:aayushchauhan525@gmail.com' },
    { img: whatsappLogo, title: 'WhatsApp', link: 'https://wa.me/+919410829728' },
    { img: instagramLogo, title: 'Instagram', link: 'https://www.instagram.com/ayush_chauhan.91/' },
      ...
      <div className="home-top">
        ...
        >
          ...
          <motion.div className="info-cards">
            {[
              { label: '📍 Location', value: 'Dehradun, Uttrakhand, India' },
